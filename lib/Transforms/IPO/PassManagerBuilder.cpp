...
// FreeSentry
static cl::opt<bool> DoFreeSentry("fs", cl::init(false),
                                      cl::desc("Enable FreeSentry"));

static cl::opt<bool> DoFreeSentryLoop("fsl", cl::init(false),
                                      cl::desc("Enable FreeSentry Loop Optimization"));

static cl::opt<bool> DoFSGraph("fsg", cl::init(false),
                                      cl::desc("Create FreeSentry call analysis"));
/*static cl::opt<std::string> FSGOFile("fsgout", cl::init(""),
                                    cl::desc("File to write FreeSentry call analysis too"));
static cl::opt<std::string> FSGIFile("fsgin", cl::init(""),
                                    cl::desc("File to read FreeSentry call model from"));
static cl::opt<std::string> FSGSFile("fsgsys", cl::init(""),
                                    cl::desc("File to read system FreeSentry call model from"));
*/
// end FreeSentry
...
void PassManagerBuilder::populateModulePassManager(PassManagerBase &MPM) {
  ...
  MPM.add(createFSGraph(DoFSGraph));
  MPM.add(createFreeSentry(DoFreeSentry));
  MPM.add(createFreeSentryLoop(DoFreeSentryLoop));
